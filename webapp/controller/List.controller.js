sap.ui.define([
    ...
    return BaseController.extend("be.ap.sap.materialsapp.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Matnr", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "be.ap.sap.materialsapp.view.ViewSettingsDialog",
                    controller: this
