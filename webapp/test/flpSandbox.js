		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Materials App",
									"targetURL": "#beapsapmaterialsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapsapmaterialsapp-display": {
								"semanticObject": "beapsapmaterialsapp",
								"action": "display",
								"description": "A Fiori application for materials",
								"title": "Materials App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.sap.materialsapp",
									"url": sap.ui.require.toUrl("be/ap/sap/materialsapp")
								}
							}
						}
					}
